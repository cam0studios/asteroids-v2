import { player, clampTime, get, set } from "./main";
...
const weapons = [
	new Weapon({
		...
		upgrades: [
			{
				id: "damage",
				name: "Damage",
				desc: "Increase damage dealt by bullets",
				func: (w) => {
					w.damage *= 1.5;
				},
				max: 4,
			...
			},
			{
				id: "fireRate",
				name: "Fire Rate",
				desc: ["Fire more frequently", "Fire even more frequently"],
				func: (w) => {
					w.fireRate *= 1.35;
				},
				max: 4,
			...
			},
			{
				...
				desc: ["Bullets travel faster", "Bullets travel even faster"],
				func: (w) => {
					w.speed *= 1.3;
				},
				max: 3,
			...
			},
			{
				...
				name: "Piercing",
				desc: [
					"50% chance for bullets to pierce enemies",
					"100% chance for bullets to pierce enemies",
					"50% chance for bullets to pierce two enemies",
					"100% chance for bullets to pierce two enemies",
				],
				func: (w) => {
					w.piercing += 0.5;
				},
			...
			},
			{
				...
				name: "Ice Shot",
				desc: [
					"Every 9th bullet freezes enemies",
					"Every 8th bullet freezes enemies",
					"Every 7th Bullet freezes enemies",
				],
				incompatible: ["fire"],
				func: (w) => w.ice--,
				weight: 0.6,
			...
			},
			{
				...
				name: "Fire Shot",
				desc: [
					"Every 9th bullet burns enemies",
					"Every 8th bullet burns enemies",
					"Every 7th Bullet burns enemies",
				],
				incompatible: ["ice"],
				func: (w) => w.fire--,
				weight: 0.6,
		...
		upgrade: (weapon) => {
			weapon.reload = 0;
			if (
				weapon.unlocks.multishotEvery > 0 &&
				weapon.level % weapon.unlocks.multishotEvery == 0 &&
				weapon.amount < 5
			) {
				weapon.amount++;
			}
